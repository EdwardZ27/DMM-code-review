...
%========DM1的计算
    for i = 1:c
        ...
        %方程系数第一行
        for j = 1
            A(j,j)   = -(Cp_DM1(j,i)+1)/Cr_DM1(j,i)-1-(Cr_DM2(j,i)+1)*(Cp_DM1(j,i)+1)/Cp_DM2(j,i)/Cr_DM1(j,i)-1/Cp_DM2(j,i);
            A(j,j+1) = 1/Cr_DM1(j,i)+1+(Cr_DM2(j,i)+1)/Cp_DM2(j,i)/Cr_DM1(j,i)+1/Cp_DM2(j,i);
        end
        for j = 2
            A(j,j-1) = (Cp_DM1(j-1,i)+1)/Cr_DM1(j-1,i)+1/Cp_DM2(j-1,i)/Cr_DM1(j-1,i)+(Cr_DM2(j-1,i)+1)*(Cp_DM1(j-1,i)+1)/Cp_DM2(j-1,i)/Cr_DM1(j-1,i)+1/Cp_DM2(j-1,i)+(Cp_DM1(j-1,i)+1)/Cp_DM2(j,i)/Cr_DM1(j-1,i);
            A(j,j)   = -1/Cr_DM1(j-1,i)-(Cp_DM1(j,i)+1)/Cr_DM1(j,i)-1-(Cr_DM2(j-1,i)+1)/Cp_DM2(j-1,i)/Cr_DM1(j-1,i)-1/Cp_DM2(j-1,i)-1/Cp_DM2(j,i)/Cr_DM1(j-1,i)-(Cr_DM2(j,i)+1)*(Cp_DM1(j,i)+1)/Cp_DM2(j,i)/Cr_DM1(j,i)-1/Cp_DM2(j,i);
            A(j,j+1) = 1/Cr_DM1(j,i)+1+(Cr_DM2(j,i)+1)/Cp_DM2(j,i)/Cr_DM1(j,i)+1/Cp_DM2(j,i);
        end
        for j = 3:DM_stage-1
            A(j,j-2) = -(Cp_DM1(j-2,i)+1)/Cp_DM2(j-1,i)/Cr_DM1(j-2,i); 
            A(j,j-1) = (Cp_DM1(j-1,i)+1)/Cr_DM1(j-1,i)+1/Cp_DM2(j-1,i)/Cr_DM1(j-1,i)+(Cr_DM2(j-1,i)+1)*(Cp_DM1(j-1,i)+1)/Cp_DM2(j-1,i)/Cr_DM1(j-1,i)+1/Cp_DM2(j-1,i)+(Cp_DM1(j-1,i)+1)/Cp_DM2(j,i)/Cr_DM1(j-1,i);
            A(j,j)   = -1/Cr_DM1(j-1,i)-(Cp_DM1(j,i)+1)/Cr_DM1(j,i)-1-(Cr_DM2(j-1,i)+1)/Cp_DM2(j-1,i)/Cr_DM1(j-1,i)-1/Cp_DM2(j-1,i)-1/Cp_DM2(j,i)/Cr_DM1(j-1,i)-(Cr_DM2(j,i)+1)*(Cp_DM1(j,i)+1)/Cp_DM2(j,i)/Cr_DM1(j,i)-1/Cp_DM2(j,i);
            A(j,j+1) = 1/Cr_DM1(j,i)+1+(Cr_DM2(j,i)+1)/Cp_DM2(j,i)/Cr_DM1(j,i)+1/Cp_DM2(j,i);
        end
...
%========DM2的计算
    ...
    for i = 1:c
        ...
        %方程系数第一行
        for j = 1
            A(j,j)   = -(Cp_DM2(j,i)+1)/Cr_DM2(j,i)-1-(Cp_DM2(j,i)+1)/Cr_DM2(j,i)/Cp_DM1(j+1,i)-(Cr_DM1(j+1,i)+1)/Cp_DM1(j+1,i)/Cr_DM2(j+1,i)-1/Cp_DM1(j+1,i)-(Cr_DM1(j,i)+1)*(Cp_DM2(j,i)+1)/Cp_DM1(j,i)/Cr_DM2(j,i)-1/Cp_DM1(j,i);
            A(j,j+1) = (Cp_DM2(j+1,i)+1)*(Cr_DM1(j+1,i)+1)/Cr_DM2(j+1,i)/Cp_DM1(j+1,i)+1/Cp_DM1(j+1,i);
        end
        for j = 2
            A(j,j-1) = (Cp_DM2(j-1,i)+1)/Cr_DM2(j-1,i)+1/Cr_DM2(j,i)+1+1/Cp_DM1(j+1,i)/Cr_DM2(j,i)+(Cp_DM2(j-1,i)+1)/Cr_DM2(j-1,i)/Cp_DM1(j,i)+(Cr_DM1(j,i)+1)/Cp_DM1(j,i)/Cr_DM2(j,i)+1/Cp_DM1(j,i);
            A(j,j)   = -(Cp_DM2(j,i)+1)/Cr_DM2(j,i)-1-(Cp_DM2(j,i)+1)/Cr_DM2(j,i)/Cp_DM1(j+1,i)-(Cr_DM1(j+1,i)+1)/Cp_DM1(j+1,i)/Cr_DM2(j+1,i)-1/Cp_DM1(j+1,i)-(Cr_DM1(j,i)+1)*(Cp_DM2(j,i)+1)/Cp_DM1(j,i)/Cr_DM2(j,i)-1/Cp_DM1(j,i);
            A(j,j+1) = (Cp_DM2(j+1,i)+1)*(Cr_DM1(j+1,i)+1)/Cr_DM2(j+1,i)/Cp_DM1(j+1,i)+1/Cp_DM1(j+1,i);
        end
        for j = 3:DM_stage-1
        ...
        for j = DM_stage
            A(j,j-2) = -1/Cr_DM2(j-1,i)-1/Cp_DM1(j,i)/Cr_DM2(j-1,i); 
            A(j,j-1) = (Cp_DM2(j-1,i)+1)/Cr_DM2(j-1,i)+1/Cr_DM2(j,i)+1+(Cp_DM2(j-1,i)+1)/Cr_DM2(j-1,i)/Cp_DM1(j,i)+(Cr_DM1(j,i)+1)/Cp_DM1(j,i)/Cr_DM2(j,i)+1/Cp_DM1(j,i);
            A(j,j)   = -(Cp_DM2(j,i)+1)/Cr_DM2(j,i)-1-(Cr_DM1(j,i)+1)*(Cp_DM2(j,i)+1)/Cp_DM1(j,i)/Cr_DM2(j,i)-1/Cp_DM1(j,i);
        end
