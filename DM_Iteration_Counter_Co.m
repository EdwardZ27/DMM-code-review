function f = DM_Iteration_Counter_Co(DM_feed,DM_error)
    ...
    DM_Profile = DM_chase_Counter_Co(DM_Profile_i,DM_feed);
    ...
    while Error_return(abs((Fp1_DM_a-Fp1_DM_b)/Fp1_DM_b),DM_error) ~=1 ...
        ...
        DM_Profile = DM_Pressure_revolve_Counter_Co(DM_Profile);
        DM_Profile = DM_chase_Counter_Co(DM_Profile,DM_feed);
