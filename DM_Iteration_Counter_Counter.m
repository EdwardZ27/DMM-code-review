function f = DM_Iteration_Counter_Counter(DM_feed,DM_error)
    ...
    %end
        Fp1_DM_a = DM_Profile_i(1,1);
        Fp2_DM_a = DM_Profile_i(2,1);
        Fr_DM_a  = DM_Profile_i(3,end);
        
    DM_Profile = DM_chase_Counter_Counter(DM_Profile_i,DM_feed);

        Fp1_DM_b = DM_Profile(1,1);
    ...
    while Error_return(abs((Fp1_DM_a-Fp1_DM_b)/Fp1_DM_b),DM_error) ~=1 ...
        ...
        DM_Profile = DM_Pressure_revolve_Counter_Counter(DM_Profile);
        DM_Profile = DM_chase_Counter_Counter(DM_Profile,DM_feed);
