...
%========DM2的计算
    for i = 1:c
        for j = 1
            vj_DM2(j,i) = -1/Cp_DM2(j,i)*lo(i)...
                         +vj_DM1(j,i)*((Cr_DM2(j,i)+1)*(Cp_DM1(j,i)+1)/Cp_DM2(j,i)/Cr_DM1(j,i)+1/Cp_DM2(j,i))...
                         +vj_DM1(j+1,i)*(-(Cr_DM2(j,i)+1)/Cr_DM1(j,i)/Cp_DM2(j,i)-1/Cp_DM2(j,i));
        end
        for j = 2:DM_stage-1
            vj_DM2(j,i) = vj_DM1(j-1,i)*(-(Cp_DM1(j-1,i)+1)/Cr_DM1(j-1,i)/Cp_DM2(j,i))...
                         +vj_DM1(j,i)*(1/Cr_DM1(j-1,i)/Cp_DM2(j,i)+(Cr_DM2(j,i)+1)*(Cp_DM1(j,i)+1)/Cp_DM2(j,i)/Cr_DM1(j,i)+1/Cp_DM2(j,i))...
                         +vj_DM1(j+1,i)*(-(Cr_DM2(j,i)+1)/Cr_DM1(j,i)/Cp_DM2(j,i)-1/Cp_DM2(j,i));
        end
        for j = DM_stage
            vj_DM2(j,i) = vj_DM1(j-1,i)*(-(Cp_DM1(j-1,i)+1)/Cr_DM1(j-1,i)/Cp_DM2(j,i))...
...
for FOLD_Revolve_profile = 1
    ...
    for i = 1:c
        %===lj===
        for j = 1:DM_stage-1
            lj_DM(j,i)  = (Cp_DM1(j,i)+1)/Cr_DM1(j,i)*vj_DM1(j,i)-vj_DM1(j+1,i)/Cr_DM1(j,i);%lo(i)-Qj_DM1(j,i)-Qj_DM2(j,i);
        end
        for j = DM_stage
            lj_DM(j,i)  = (Cp_DM1(j,i)+1)/Cr_DM1(j,i)*vj_DM1(j,i);%lj_DM(j-1,i)-Qj_DM1(j,i)-Qj_DM2(j,i);
        end
    end
